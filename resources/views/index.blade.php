        ...
        <div class="col-lg-4 col-xxl-3 ps-lg-2">
            {{-- <x-card>
                                <div class="card-header d-flex flex-between-center bg-light py-2">
                                    <h6 class="mb-0">Mest viste bedrifter</h6>
                                </div>
                                        ...
                                        <div class="d-flex align-items-center position-relative mb-3">
                                            <div class="flex-1">
                                                <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900"
                                                        href="{{ url('bedrifter/' . $company->place->slug . '/' . $company->org_id . '/' . Str::of($company->title)->slug('-')) }}">{{ $company->title }}</a>
                                                </h6>
                                            </div>
                                        </div>
                                    @empty
                                ...
                                <div class="card-footer bg-light p-0"><a class="btn btn-sm btn-link d-block w-100 py-2"
                                        href="{{ url('/bedrifter') }}">Vis flere bedrifter</a></div>
                            </x-card> --}}
        </div>
    </div>
</x-layout>
            ...
            <div class="ml-12">
                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                    Laravel's robust library of first-party tools and libraries, such as <a
                        ...
                        href="https://envoyer.io" class="underline">Envoyer</a> help you take your projects to the
