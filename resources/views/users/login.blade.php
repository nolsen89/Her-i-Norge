                ...
                <div class="card-body p-4 p-sm-5">
                    <div class="row flex-between-center mb-2">
                        ...
                        <div class="col-auto fs--1 text-600"><span class="mb-0 undefined">or</span> <span><a
                                    href="/register">Create an account</a></span></div>
                    </div>
                    <form method="POST" action="/users/authenticate">
                        ...
                        <div class="mb-3"><input class="form-control" type="password" name="password"
                                placeholder="Password" value="{{ old('password') }}"></div>
                        <div class="row flex-between-center">
                            <div class="col-auto">
                                <div class="form-check mb-0"><input class="form-check-input" type="checkbox"
                                        id="basic-checkbox" name="remember_me" checked="checked"><label class="form-check-label mb-0"
                    ...
                    <div class="row g-2 mt-2">
                        <div class="col-sm-6"><a class="btn btn-outline-google-plus btn-sm d-block w-100"
                                href="#"><svg class="svg-inline--fa fa-google-plus-g fa-w-20 me-2"
                                    ...
                                    viewBox="0 0 640 512" data-fa-i2svg="" style="transform-origin: 0.625em 0.5em;">
